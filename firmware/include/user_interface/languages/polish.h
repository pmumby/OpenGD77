...
.sound_options				= "Opcje dùwiÜku", // MaxLen: 16
...
.gotoChannel				= "Idù do",  // MaxLen: 11 (" 1024")
...
.brightness				= "JasnoùÇ", // MaxLen: 16 (with ':' + 0..100 + '%')
.brightness_off				= "Mini jasnoùÇ", // MaxLen: 16 (with ':' + 0..100 + '%')
...
.DISMISS				= "ODWOáAù", // MaxLen: 8 (choice above green/red buttons)
